...
-- Migrate existing static content to content blocks (FAQ example)
INSERT INTO public.content_blocks (block_key, block_type, title, content, metadata) VALUES
  ...
  ('testimonials_section', 'grid', 'Customer Testimonials',
   '{"columns": 2, "items": [{"title": "Sarah Johnson", "description": "OpenT has revolutionized my creative process. The quality of generated images is outstanding!", "image": "https://i.pravatar.cc/150?img=1"}, {"title": "Michael Chen", "description": "We use OpenT for all our marketing visuals now. It\'s fast, efficient, and the results are amazing.", "image": "https://i.pravatar.cc/150?img=2"}]}',
   '{"migrated_from": "static", "source_page": "/testimonials"}'
  );