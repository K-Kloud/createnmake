...
-- Insert default alert configurations (using correct agent_id = 2)
INSERT INTO ai_alert_config (agent_id, alert_type, threshold_value, threshold_operator) VALUES
(2, 'health', 80, '<'),  -- Alert if success rate < 80%
(2, 'performance', 5000, '>'),  -- Alert if response time > 5000ms
(2, 'queue', 10, '>');  -- Alert if queue has > 10 pending tasks