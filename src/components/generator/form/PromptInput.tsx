        ...
        <div className="relative group">
          ...
          <div className="relative bg-background/80 backdrop-blur-sm border border-border/60 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary/40 transition-all duration-200">
            <Input 
              ...
              className="border-0 bg-transparent px-4 py-6 text-base placeholder:text-muted-foreground/70 focus-visible:ring-0 focus-visible:ring-offset-0 pr-32"
            />
            ...
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                    ...
                    <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
                      ...
                      <PopoverContent className="w-72 p-4 border-border/60 bg-background/95 backdrop-blur-sm">
                        <label 
                          ...
                          className={`flex flex-col items-center justify-center cursor-pointer py-6 rounded-lg border-2 border-dashed border-border/60 hover:border-primary/40 transition-colors ${
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                className="h-9 w-9 rounded-lg bg-primary/10 hover:bg-primary/20 text-primary hover:text-primary transition-colors" 
                onClick={onGenerate} 
